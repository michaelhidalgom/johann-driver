...
export default function ReservasSection() {
  ...
  const inputClass = "w-full bg-slate-50 border border-slate-200 rounded-lg px-4 py-2 text-sm outline-none focus:border-[#C5A059] focus:ring-1 focus:ring-[#C5A059] transition-all"
  const labelClass = "block text-[10px] uppercase font-bold tracking-[0.1em] text-slate-500 mb-2"

  return (
    <section id="reservas" className="py-10 bg-slate-50 border-y border-slate-200 scroll-mt-20">
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div>
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-5 text-slate-800 leading-tight">
              Agende su <br /><span className="text-[#C5A059]">traslado</span> hoy.
            </h2>
            <p className="text-slate-500 font-light leading-relaxed text-sm mb-8 max-w-md">
          ...
          <div className="bg-white rounded-2xl border border-slate-100 p-6 shadow-xl">
            ...
            {formState === 'success' ? (
              ...
              <>
                <h3 className="text-xl font-bold text-slate-800 mb-1">Pre-Reserva</h3>
                ...
                <div className="space-y-3">
                  ...
                  <button
                    ...
                    className="w-full bg-[#C5A059] text-white py-3 rounded-lg font-bold text-xs uppercase tracking-[0.2em] hover:bg-amber-600 transition shadow-lg disabled:opacity-50 disabled:pointer-events-none flex items-center justify-center gap-2"
                  >
                    {formState === 'loading' ? (
                      <>
